...
for f in files:
    try:
        ...
        if not(f in list):
            ...
            i = i+1
            s = 'data/128_128/Normal/' + str(i) + '_xxxx_128.png'
...
for f in files3:
    try:
        ...
        i = i+1
        k= k+1
        s = 'data/128_128/Normal/' + str(i) + '_healthy_xxxx_128.png'
        s1 = s.replace('xxxx','Normal')
        s2 = s.replace('xxxx','Mirror')
        s3 = s.replace('xxxx','Solarize')
        s4 = s.replace('xxxx','Solarize_Mirror')
...
for f in files2:
    try:
        ...
        i = i+1
        j = j+1
        s = 'data/128_128/Normal/' + str(i) + '_covid_xxxx_128.png'
        s1 = s.replace('xxxx','Normal')
        s2 = s.replace('xxxx','Mirror')
        s3 = s.replace('xxxx','Solarize')
        s4 = s.replace('xxxx','Solarize_Mirror')
...
pickle.dump(dictSampletoLabel,open("dictSampletoLabel_128_NoAugmentation.p","wb"))
